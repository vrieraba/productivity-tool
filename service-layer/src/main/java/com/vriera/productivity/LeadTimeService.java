...
public class LeadTimeService {
    ...
    private static List<TaskSubType> LEAD_TIME_TASK_SUB_TYPES = Arrays.asList(TaskSubType.ANALISIS, TaskSubType.CODIFICACION, TaskSubType.PRUEBA, TaskSubType.DESPLIEGUE);
